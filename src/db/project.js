export const projects = [
    {
        id:1,
        link_website:"https://decoration-world-lc.web.app",
        name_project:"ecomerce (react + django)",
        description_project:"This is a project for a client, this app contain a API of DJANGO con JWT, and ENDPOINT publics and private(IsAuthenticated) how login, review, checkout, shopping and a database.",
        tools:[
            {
                id:1,
                name_tool : "django"
    ...
    {
        id:2,
        link_website:"https://github.com/ChrisLCoop/portfolia_v1_react",
        name_project:"my portfolio v1 - REACT",
        description_project:"This project was built with react with dependencies",
        tools:[
            {
                id:1,
                name_tool : "react + swc"
    ...
    {
        id:4,
        link_website:"https://cl-metalmecanica.web.app",
        name_project:"metalmecanica website",
        description_project:"The company need show your products and service, detailing each project and service with your respective photos of the product and service.",
        tools:[
            {
                id:1,
                name_tool : "react + swc"
    ...
    {
        id:6,
        link_website:"https://github.com/ChrisLCoop/da_movies_streaming",
        name_project:"analisis data movies Netflix, Prime, Hulu, Disney +",
        description_project:"This project analyzes a dataset containing information about movies available on the major streaming platforms: Netflix, Prime Video, Hulu, and Disney+. Aspects such as release years, age ratings, and Rotten Tomatoes scores are examined.",
        tools:[
            {
                id:1,
                name_tool : "python"
