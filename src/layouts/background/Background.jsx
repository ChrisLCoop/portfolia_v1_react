        ...
        <div className="content-all-background">
            <div className="cont-blq-bk">
                ...
                <div className="cont-back-b">
                    <p>I'm currently study Data Analysis of GOOGLE in Coursera, At the same time, I have a scholarship that allows me to study fundamentals of Google AI and Google Cybersecurity.</p>
                    <p>As a Full-Stack Developer, I enjoy build applications that can be of great help to people</p>
                </div>
            </div>
            <div className="cont-blq-bk">
                <div className="cont-back-a">
            ...
            <div className="cont-blq-bk">
                ...
                <div className="cont-back-b">
                    <div className="cards-exp-b">
                        <div className="card-dtl-info-exp">
                            <div className="crd-inf-x">
                                <p className='ttl-prsk'>erp basic (React + Django)</p>
                                <p className='p-info-ex-p'>design and implementation with independent module , how user, sales, inventory etc</p>
                                <p className='p-info-ex-p'>integration with React + SWC</p>
                                <p className='p-info-ex-p'>backend's build with django, using serializers and viewset</p>
                        ...
                        <div className="card-dtl-info-exp">
                            <div className="crd-inf-x">
                                ...
                                <p className='p-info-ex-p'>design of cart, bonus, discount dynamic for each product</p>
                                <p className='p-info-ex-p'>login, account, checkout, and buy section is authenticated by JWT (API)</p>
                                <p className='p-info-ex-p'>model 3D integration and view AR (Augmented Reality) for increment the view of product</p>
                            </div>
                            <div className="crd-inf-y">
